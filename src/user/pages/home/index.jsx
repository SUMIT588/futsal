        ...
        <div className="col-sm-6">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-text">Book a futsal court online and enjoy playing with your friends.</p>
        ...
        <div className="col-sm-6">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-text">Manage your futsal court bookings and keep track of your playing history.</p>
